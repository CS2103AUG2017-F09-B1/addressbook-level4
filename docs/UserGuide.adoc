...
Adds a temporary person to the address book which will be deleted when the number of days specified has elapsed +
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [temp/NUMBER_OF_DAYS] [t/TAG]...`

[TIP]
Deletion of temporary person is done at the start up of the addressbook.
