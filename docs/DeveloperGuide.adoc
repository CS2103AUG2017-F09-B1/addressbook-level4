...
The autocomplete feature utilizes the AutoComplete class under Logic and is implemented in CommandBox under UI.

The autocomplete list is updated every update instance of the model component.
